...
module UO
    ...
    SKILL_NAMES = {
        ...
        SKILL_DETECT_HIDDEN => 'DetectHidden',
        SKILL_DISCORDANCE => 'Discordance',
        SKILL_EVAL_INT => 'EvalInt',
        ...
        SKILL_INSCRIBE => 'Inscribe',
        SKILL_LOCKPICKING => 'Lockpicking',
        SKILL_MAGERY => 'Magery',
        SKILL_MAGIC_RESIST => 'MagicResist',
        ...
        SKILL_SPIRIT_SPEAK => 'SpiritSpeak',
        SKILL_STEALING => 'Stealing',
        SKILL_TAILORING => 'Tailoring',
        SKILL_ANIMAL_TAMING => 'AnimalTaming',
        SKILL_TASTE_ID => 'TasteID',
        SKILL_TINKERING => 'Tinkering',
        SKILL_TRACKING => 'Tracking',
        SKILL_VETERINARY => 'Veterinary',
        SKILL_SWORDS => 'Swords',
        SKILL_MACING => 'Macing',
        SKILL_FENCING => 'Fencing',
        SKILL_WRESTLING => 'Wrestling',
        SKILL_LUMBERJACKING => 'Lumberjacking',
        SKILL_MINING => 'Mining',
        ...
        SKILL_FOCUS => 'Focus',
        SKILL_CHIVALRY => 'Chivalry',
        SKILL_BUSHIDO => 'Bushido',
    }
